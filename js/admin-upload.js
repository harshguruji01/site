        ...
        <tr>
            ...
            <td>
                <div style="display:flex; align-items:center; gap: 6px;">
                    <a href="store-detail.html?slug=${encodeURIComponent(app.slug)}" target="_blank" style="color:#38bdf8; font-size: 0.85rem; text-decoration:none; max-width: 140px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        /store-detail.html?slug=${app.slug}
                    </a>
...
window.copyAppUrl = function(slug) {
    const fullUrl = `${window.location.origin}/store-detail.html?slug=${encodeURIComponent(slug)}`;
